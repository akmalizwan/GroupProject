...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td class="auto-style64" style="border-style: none; background-color: #0059BD">
                    <asp:Button ID="Button2" runat="server" CssClass="auto-style67" Text="Submit" Width="261px" BorderColor="Yellow" BorderStyle="None" Height="50px" BackColor="Yellow" OnClick="Button2_Click" />
                </td>
                <td class="auto-style51">&nbsp;</td>
            </tr>
        </table>
